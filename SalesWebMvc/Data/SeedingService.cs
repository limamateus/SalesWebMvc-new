...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob", "Bob@gmail.com", 1000.0, new DateTime(1998, 4, 21), d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 3500.0, new DateTime(1979, 12, 31), d2);
            Seller s3 = new Seller(3, "Alex", "alex@gmail.com", 2200.0, new DateTime(1988, 1, 15), d1);
            Seller s4 = new Seller(4, "Marta", "marta@gmail.com", 3000.0, new DateTime(1998, 4, 21), d4);
            Seller s5 = new Seller(5, "Donald blue", "donal@gmail.com", 4000.0, new DateTime(2000, 1, 9), d3);
            Seller s6 = new Seller(6, "Alex Pink", "alexpink@gmail.com", 3000.0, new DateTime(1997, 3, 4), d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2008, 09, 25), 11000.0, SaleStatus.Billed, s1);
